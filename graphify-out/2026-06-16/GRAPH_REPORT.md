...
## Corpus Check
- 78 files · ~2,424,099 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 959 nodes · 1971 edges · 65 communities (59 shown, 6 thin omitted)
...
5. `reasoning.md — no-scroll` - 21 edges
...
## Knowledge Gaps
- **222 isolated node(s):** `PreToolUse`, `Bundle`, `NavSelectionState`, `InstagramBlockSurface`, `ReaderSelection` (+217 more)
