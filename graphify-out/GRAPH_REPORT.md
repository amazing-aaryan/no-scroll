# Graph Report - no-scroll  (2026-06-23)

## Corpus Check
- 91 files · ~2,434,057 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1120 nodes · 2200 edges · 84 communities (76 shown, 8 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 101 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d7cb86b8`
...
- `StylePackCard()` --calls--> `Text`  [INFERRED]
  app/src/main/java/com/noscroll/quote/QuoteCardPreviewActivity.kt → app/src/main/java/com/noscroll/metadata/CoverPageOcr.kt
- `StylePicker()` --calls--> `Text`  [INFERRED]
  app/src/main/java/com/noscroll/quote/QuoteCardPreviewActivity.kt → app/src/main/java/com/noscroll/metadata/CoverPageOcr.kt
...
Cohesion: 0.25
Nodes (15): BookEntity, BookMetadataEntity, Boolean, Float, Int, Long, Modifier, String (+7 more)
...
Cohesion: 0.10
Nodes (23): Boolean, Float, Int, List, PdfDocument, PdfRect, ReaderSelection, RectF (+15 more)
...
Cohesion: 0.15
Nodes (18): Bitmap, Boolean, Context, Float, Int, List, QuoteCardSpec, QuoteCardStylePack (+10 more)
...
Cohesion: 0.20
Nodes (9): Alt text, Caption, First comment, Hashtags, Image / Carousel, NoScroll - First Social Post, On-image headline, Short caption (+1 more)
...
Cohesion: 0.24
Nodes (14): BookEntity, BookMetadataEntity, Boolean, HighlightEntity, List, String, TutorialController, Unit (+6 more)

### Community 24 - "Community 24"
Cohesion: 0.33
Nodes (5): Current Release, Local Overrides, NoScroll Android Versioning, Pre-upload Check, Release Rules
...
Cohesion: 0.11
Nodes (18): Architecture, Book Metadata, Collections, Core Mechanism: Instagram Interception, Current Product Position, Highlights And Notebook, Highlights System, Instagram Blocker (+10 more)
...
Cohesion: 0.15
Nodes (12): Blocker behavior, Build, Caveats, First-run setup, How it works, NoScroll, Play release, Prerequisites (+4 more)
...
Cohesion: 0.40
Nodes (5): 2026-06-12 21:00 EET - Reviewer Follow-up: Overlay Touchability Lifecycle, Direct overlay command attempt, Final deployment note, Lifecycle E2E attempt, Reviewer finding addressed
...
Cohesion: 0.33
Nodes (5): Data NoScroll Handles, Data Sharing, NoScroll Privacy Policy, Permissions, User Control
...
Cohesion: 0.08
Nodes (27): Bundle, Intent, Bundle, Bundle, LegalBookSearchResult, List, String, Uri (+19 more)

### Community 68 - "Community 68"
Cohesion: 0.21
Nodes (11): AccessibilityService, Boolean, Bundle, Intent, String, TutorialPrefs, PermissionDisclosure, PermissionDisclosureDialog() (+3 more)

### Community 69 - "Community 69"
Cohesion: 0.23
Nodes (10): TutorialController, TutorialStepId, String, TutorialController, Unit, NotebookState, TutorialAnchor(), NotebookQuoteRow() (+2 more)

### Community 70 - "Community 70"
Cohesion: 0.15
Nodes (12): Accessibility Service, Build Gate, Current Policy Risk, Data Safety Summary, Display Over Other Apps, Foreground Service: `specialUse`, Internet, NoScroll Play Store Release Checklist (+4 more)
...
Cohesion: 0.36
Nodes (10): Boolean, List, Modifier, String, T, PaperActionButton(), PaperButtonTone, PaperChoiceChip() (+2 more)

### Community 73 - "Community 73"
Cohesion: 0.53
Nodes (9): Boolean, LegalBookSearchResult, List, String, Text, NoticeCard(), OnlineBookSearchScreen(), SearchActionRow() (+1 more)

### Community 74 - "Community 74"
Cohesion: 0.53
Nodes (5): TutorialController, TutorialStep, Layout, TooltipCard(), TutorialOverlay()

### Community 78 - "Community 78"
Cohesion: 0.18
Nodes (10): App Access / Review Notes, App Name, Category, Content Rating Notes, Feature Graphic / Screenshot Storyboard, Full Description, NoScroll Play Store Listing Draft, Policy Notes (+2 more)

### Community 79 - "Community 79"
Cohesion: 0.20
Nodes (9): Can users request data deletion?, Data Collection Summary, Does the app collect or share any required user data types?, Is all collected data encrypted in transit?, Is data shared with third parties?, NoScroll Data Safety Draft, Permissions And Data Mapping, Play Console Answers (+1 more)

### Community 80 - "Community 80"
Cohesion: 0.33
Nodes (5): Device QA, Device QA Still Required, External Play Console Tasks, NoScroll Release Verification, Verified Locally

### Community 81 - "Community 81"
Cohesion: 0.50
Nodes (3): Modifier, Dp, BrandMark()

## Knowledge Gaps
- **314 isolated node(s):** `PreToolUse`, `Bundle`, `NavSelectionState`, `InstagramBlockSurface`, `ReaderSelection` (+309 more)
...
- **Why does `PdfViewerActivity` connect `Community 0` to `Community 8`, `Community 67`, `Community 4`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `TutorialOverlay()` connect `Community 74` to `Community 0`, `Community 68`, `Community 69`, `Community 11`, `Community 23`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Canvas` connect `Community 11` to `Community 74`, `Community 67`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Are the 28 inferred relationships involving `Text` (e.g. with `PermissionDisclosureDialog()` and `PermissionRow()`) actually correct?**
  _`Text` has 28 INFERRED edges - model-reasoned connections that need verification._
